...
python train.py --width 128 --height 64 --length 6 --batch-size 32 --train-dataset generated-images/training/images --validate-dataset generated-images/validation/images --output-model-name model.h5 --symbols symbols.txt --epochs 5
